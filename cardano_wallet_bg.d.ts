...
export function __wbg_transactionsignature_free(a: number): void;
export function transactionsignature_from_hex(a: number, b: number): number;
export function transactionsignature_to_hex(a: number, b: number): void;
...
export function transactionid_to_hex(a: number, b: number): void;
export function transactionid_from_hex(a: number, b: number): number;
export function __wbg_txopointer_free(a: number): void;
export function txopointer_new(a: number, b: number): number;
...
export function signedtransaction_from_bytes(a: number, b: number): number;
...
export function witness_new_extended_key(a: number, b: number, c: number): number;
export function witness_new_redeem_key(a: number, b: number, c: number): number;
...
export function __wbg_txinput_free(a: number): void;
export function txinput_new(a: number, b: number): number;
export function txinput_to_json(a: number): number;
export function txinput_from_json(a: number): number;
export function __wbg_inputselectionbuilder_free(a: number): void;
export function inputselectionbuilder_first_match_first(): number;
export function inputselectionbuilder_largest_first(): number;
export function inputselectionbuilder_blackjack(a: number): number;
export function inputselectionbuilder_add_input(a: number, b: number): void;
export function inputselectionbuilder_add_output(a: number, b: number): void;
export function inputselectionbuilder_select_inputs(a: number, b: number, c: number): number;
export function __wbg_inputselectionresult_free(a: number): void;
export function inputselectionresult_is_input(a: number, b: number): number;
export function inputselectionresult_estimated_fees(a: number): number;
export function inputselectionresult_estimated_change(a: number): number;
